...
class BodySystem(Enum):
    ...
    HEMATOLOGICAL = 9
    IMMUNOLOGICAL = 10
    REPRODUCTIVE = 11  # New body system for reproductive health
    ...
    def _get_default_knowledge(self) -> Dict:
        ...
        return {
            "conditions": [
                ...
                {
                    "icd11": "GA34.4",
                    "name": "Dysmenorrhea (Painful menstruation)",
                ...
                },
                {
                    ...
                    "systems": ["REPRODUCTIVE", "HEMATOLOGICAL"],
                    "prevalence": 0.15,
                    "symptoms": {
                        "heavy_bleeding": 9.0,
                        "prolonged_bleeding": 8.5,
                        "fatigue": 7.0,
                        "shortness_of_breath": 6.5,
                        "pale_skin": 6.0,
                        "dizziness": 5.5
                    },
                    "criteria": ["heavy_bleeding", "prolonged_bleeding"],
                    "risk_factors": {
                        "age>40": 1.6,
                        "obesity": 1.4,
                        "family_history": 1.3
                    ...
                    "red_flags": [
                        ["heavy_bleeding", "fatigue", "shortness_of_breath"]
                    ],
                    "labs": {
                        "hemoglobin": ["<", 12],
                        "ferritin": ["<", 30]
                ...
                {
                    "icd11": "GA34.2",
                    "name": "Amenorrhea (Absent menstruation)",
                ...
                },
                {
                    ...
                    "systems": ["REPRODUCTIVE", "PSYCHIATRIC"],
                    "prevalence": 0.75,
                    "symptoms": {
                        "mood_swings": 8.0,
                        "irritability": 7.5,
                        "bloating": 7.0,
                        "breast_tenderness": 6.5,
                        "fatigue": 6.0,
                        "food_cravings": 5.5,
                        "headaches": 5.0
                    },
                    "criteria": ["mood_swings", "irritability"],
                    "risk_factors": {
                        "age>30": 1.4,
                        "stress": 1.6,
                        "family_history": 1.3
                ...
                },
                {
                    ...
                    "prevalence": 0.10,
                    "symptoms": {
                        "irregular_periods": 8.5,
                        "excess_hair_growth": 7.5,
                        "acne": 6.5,
                        "weight_gain": 7.0,
                        "infertility": 8.0,
                        "fatigue": 5.5
                    },
                    "criteria": ["irregular_periods", "excess_hair_growth"],
                    "risk_factors": {
                        "obesity": 2.0,
                        "family_history": 1.8,
                        "insulin_resistance": 2.2
                    },
                    "red_flags": [],
                    "labs": {
                        "testosterone": [">", 70],
                ...
                },
                {
                    ...
                    "symptoms": {
                        "pelvic_pain": 9.0,
                        "vaginal_bleeding": 8.5,
                        "shoulder_pain": 7.5,
                        "dizziness": 7.0,
                        "fainting": 8.0,
                        "nausea": 6.5
                    },
                    "criteria": ["pelvic_pain", "vaginal_bleeding"],
                    "risk_factors": {
                        "previous_ectopic": 10.0,
                        "pelvic_inflammatory_disease": 3.0,
                        "tubal_surgery": 4.0
                    },
                    "red_flags": [
                        ["pelvic_pain", "vaginal_bleeding", "shoulder_pain"]
                    ],
                    "labs": {
                        "pregnancy_test": ["==", "positive"],
                        "hcg": [">", 2000]
                ...
                },
                {
                    ...
                    "prevalence": 0.15,
                    "symptoms": {
                        "vaginal_bleeding": 9.0,
                        "pelvic_cramping": 8.5,
                        "tissue_passing": 8.0,
                        "back_pain": 6.5,
                        "abdominal_pain": 7.5
                    },
                    "criteria": ["vaginal_bleeding", "pelvic_cramping"],
                    "risk_factors": {
                        "age>35": 1.8,
                    ...
                    "red_flags": [
                        ["vaginal_bleeding", "pelvic_cramping", "tissue_passing"]
                    ],
                    "labs": {
                        "pregnancy_test": ["==", "positive"]
                    },
                ...
                },
                {
                    ...
                    "symptoms": {
                        "pelvic_pain": 9.0,
                        "painful_sex": 8.5,
                        "painful_bowel_movements": 7.0,
                        "infertility": 7.5,
                        "heavy_periods": 6.5,
                        "fatigue": 6.0
                    },
                    "criteria": ["pelvic_pain", "painful_sex"],
                    "risk_factors": {
                        "family_history": 2.0,
                        "nulliparity": 1.5,
                        "early_menarche": 1.3
                ...
                },
                {
                    ...
                    "symptoms": {
                        "heavy_bleeding": 8.0,
                        "pelvic_pressure": 7.5,
                        "frequent_urination": 6.5,
                        "back_pain": 6.0,
                        "painful_sex": 5.5,
                        "constipation": 5.0
                    },
                    "criteria": ["heavy_bleeding", "pelvic_pressure"],
                    "risk_factors": {
                        "age>30": 1.6,
                        "obesity": 1.4,
                        "family_history": 1.8
                ...
                },
                {
                    ...
                    "symptoms": {
                        "hot_flashes": 8.5,
                        "night_sweats": 8.0,
                        "irregular_periods": 7.5,
                        "mood_changes": 7.0,
                        "vaginal_dryness": 6.5,
                        "sleep_problems": 6.0,
                        "weight_gain": 5.5
                    },
                    "criteria": ["hot_flashes", "irregular_periods"],
                    "risk_factors": {
                        "age>45": 2.0,
                        "smoking": 1.5,
                        "family_history": 1.3
                ...
                },
                {
                    ...
                    "systems": ["REPRODUCTIVE", "IMMUNOLOGICAL"],
                    "prevalence": 0.05,
                    "symptoms": {
                        "pelvic_pain": 9.0,
                        "abnormal_discharge": 8.5,
                        "fever": 7.5,
                        "painful_sex": 7.0,
                        "irregular_bleeding": 6.5,
                        "nausea": 5.5
                    },
                    "criteria": ["pelvic_pain", "abnormal_discharge"],
                    "risk_factors": {
                        "multiple_partners": 2.5,
                        "previous_sti": 3.0,
                        "douching": 1.8
                    },
                    "red_flags": [
                        ["pelvic_pain", "fever", "abnormal_discharge"]
                    ],
                    "labs": {
                        "white_blood_cells": [">", 11000]
                    },
                    "rarity": "UNCOMMON",
                    "severity": "HIGH"
                }
            ...
            "medication_effects": {
                ...
                "birth_control_pills": {
                    "masks": ["regular_periods"],
                    "causes": ["mood_changes", "weight_gain", "breast_tenderness"]
                },
                "hormone_replacement_therapy": {
                    "causes": ["hot_flashes", "mood_changes", "breast_tenderness"]
                }
            },
            "symptom_synonyms": {
                ...
                "pelvic_pain": ["lower abdominal pain", "cramps", "stomach pain"],
                "heavy_bleeding": ["excessive bleeding", "flooding", "heavy periods"],
                "hot_flashes": ["hot flushes", "night sweats", "heat waves"],
                "irregular_periods": ["missed periods", "unpredictable periods", "no periods"],
                "mood_swings": ["emotional changes", "mood changes", "irritability"],
                "breast_tenderness": ["sore breasts", "breast pain", "tender breasts"],
                "vaginal_bleeding": ["spotting", "bleeding", "period bleeding"],
                "abnormal_discharge": ["unusual discharge", "vaginal discharge", "discharge"]
            },
            "emergency_locations": {
                "default_er": {
...
class EnhancedSymptomAnalyzer:
    ...
    def _check_red_flags(self, symptoms: Dict[str, Tuple[float, Optional[SymptomDuration]]]) -> List[str]:
        ...
        critical_symptoms = {
            ...
            "pelvic_pain": "Possible gynecological emergency - seek immediate care",
            "vaginal_bleeding": "Possible pregnancy complication or gynecological emergency",
            "shoulder_pain": "Possible ectopic pregnancy - seek immediate care",
            "fainting": "Possible pregnancy complication or cardiovascular issue",
            "heavy_bleeding": "Possible anemia or gynecological emergency",
            "fever": "Possible infection requiring immediate treatment"
        }
        ...
        # Additional women-specific red flag combinations
        women_critical_combos = [
            ({"pelvic_pain", "vaginal_bleeding", "shoulder_pain"}, "Possible ectopic pregnancy - EMERGENCY"),
            ({"vaginal_bleeding", "pelvic_cramping", "tissue_passing"}, "Possible miscarriage - seek immediate care"),
            ({"pelvic_pain", "fever", "abnormal_discharge"}, "Possible pelvic inflammatory disease - urgent care needed"),
            ({"heavy_bleeding", "fatigue", "shortness_of_breath"}, "Possible severe anemia - urgent evaluation needed"),
            ({"no_periods", "nausea", "breast_tenderness"}, "Possible pregnancy - consider pregnancy test")
        ]
        
        for combo, message in women_critical_combos:
            if combo.issubset(set(symptoms.keys())):
                red_flags.append(f"Critical combination: {', '.join(combo)} - {message}")
...
if __name__ == "__main__":
    ...
    print("TEST CASE 1: Cardiac Symptoms")
    print("-" * 30)
    ...
    # Test case 2: Women's health symptoms
    print("\nTEST CASE 2: Women's Health Symptoms")
    print("-" * 30)
    women_symptoms = ["pelvic pain", "heavy bleeding", "fatigue"]
    women_durations = {
        "pelvic_pain": "DAYS_1_TO_3",
        "heavy_bleeding": "WEEKS_1_TO_2"
    }
    ...
    print(f"Analyzing symptoms: {', '.join(women_symptoms)}")
    print(f"With durations: {women_durations}")
    print(f"With lab values: {women_labs}")
    
    women_analysis = analyze_symptoms_and_suggest_conditions(
        symptoms=women_symptoms,
        age=35,
        gender="F",
        existing_conditions=[],
        medications=["birth_control_pills"],
        symptom_durations=women_durations,
        lab_values=women_labs,
        risk_factors={"family_history"}
    )
    
    # Display results
    if women_analysis["has_red_flags"]:
        print("\n🚨 RED FLAG WARNINGS:")
        for flag in women_analysis["red_flags"]:
            print(f"- {flag}")
    
    print("\nTOP DIAGNOSES:")
    for i, condition in enumerate(women_analysis["possible_conditions"][:3], 1):
        print(f"\n{i}. {condition['condition_name']} (ICD11: {condition['icd11_code']})")
        print(f"   🔍 Confidence: {condition['confidence']:.1f}%")
        print(f"   ⚠️ Urgency: {condition['urgency']}")
        print(f"   📋 Evidence: {condition['evidence_summary']}")
